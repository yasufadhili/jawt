...
func (cm *CompilerManager) initBuildCache() {
	cacheFile := filepath.Join(cm.project.TempDir, ".jawt_cache.json")
	cm.buildCache = &Cache{
		CacheFile: cacheFile,
...
func (cm *CompilerManager) loadBuildCache() error {
...
func (cm *CompilerManager) saveBuildCache() error {
...
func (cm *CompilerManager) calculateFileHash(filePath string) (string, error) {
...
func (cm *CompilerManager) hasChanged(filePath string) (bool, error) {
	// Get file info
...
func (cm *CompilerManager) getChangedFiles() ([]string, error) {
...
func (cm *CompilerManager) getDependentFiles(filePath string) []string {
...
func (cm *CompilerManager) getFilesToRecompile() ([]string, error) {
...
func (cm *CompilerManager) updateCacheRecord(filePath string) error {
	info, err := os.Stat(filePath)
	if err != nil {
		return err
	}
...
func (cm *CompilerManager) ClearCache() error {
...
func (cm *CompilerManager) GetCacheStats() CacheStats {
	return CacheStats{
...
func (cm *CompilerManager) calculateCacheSize() int64 {
...
func (cm *CompilerManager) getLastCacheModification() time.Time {
	info, err := os.Stat(cm.buildCache.CacheFile)
	if err != nil {
		return time.Time{}
	}
...
func (cm *CompilerManager) compileFile(filePath string) error {
...
func (cm *CompilerManager) ValidateDependencies() error {
	// Check for cycles
...
func (cm *CompilerManager) GetBuildOrder() ([]string, error) {
	return cm.depGraph.BuildOrder()
}

// PrintBuildPlan outputs the planned build order
func (cm *CompilerManager) PrintBuildPlan() error {
