...
// Stats contains statistics about a managed process
type Stats struct {
...
func NewManagedProcess(name string, options Options, ctx context.Context, logger core.Logger) *ManagedProcess {
...
func (mp *ManagedProcess) GetStats() Stats {
	mp.mu.RLock()
	defer mp.mu.RUnlock()
