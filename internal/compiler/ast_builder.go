...
func (b *AstBuilder) VisitDoctypeSpecifier(ctx *parser.DoctypeSpecifierContext) interface{} {
...
func (b *AstBuilder) VisitImportStatement(ctx *parser.ImportStatementContext) interface{} {
...
func (b *AstBuilder) VisitDocumentContent(ctx *parser.DocumentContentContext) interface{} {
...
func (b *AstBuilder) VisitPageDefinition(ctx *parser.PageDefinitionContext) interface{} {
...
func (b *AstBuilder) VisitComponentDefinition(ctx *parser.ComponentDefinitionContext) interface{} {
...
func (b *AstBuilder) VisitPageProperty(ctx *parser.PagePropertyContext) interface{} {
	prop := &PropertyNode{}
